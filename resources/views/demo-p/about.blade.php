            ...
            <div class="container py-5 pb-5">
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 py-3">
                        ...
                        <button class="btn btn-info col-6">click here </button>
                    </div>
                    <!-- image area  -->
                    <div class="col-12 col-md-6"><img src="./img/abd1.jpg" alt="banner" class="img-fluid"></div>
                </div>
            </div>
        </section>
        ...
        <section id="about-text-area" class="d-flex justify-content-center align-items-center">
            <div class="container">
                <div class="bg-light shadow">
                    <p class="p-3 p-md-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad eos in suscipit
                        vitae
